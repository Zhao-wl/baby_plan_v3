...
gjq(){return null},
fa(){if(this.f||this.b.r)throw A.b(A.B(u.D))},
fd(){var s,r=this,q=r.e=!1,p=r.a,o=p.b
p=p.c.d
do s=p.sqlite3_step(o)
while(s===100)
if(s!==0?s!==101:q)A.fF(r.b,s,"executing statement",r.c,r.d)},
jd(){var s,r,q,p,o,n,m=this,l=A.f([],t.gz),k=m.e=!1
for(s=m.a,r=s.b,s=s.c.d,q=-1;p=s.sqlite3_step(r),p===100;){if(q===-1)q=s.sqlite3_column_count(r)
p=[]
for(o=0;o<q;++o)p.push(m.j_(o))
l.push(p)}if(p!==0?p!==101:k)A.fF(m.b,p,"selecting from statement",m.c,m.d)
n=m.gi4()
m.gjq()
k=new A.hI(l,n,B.aM)
k.i1()
